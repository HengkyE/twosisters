...
const treatmentDataMap: Record<string, TreatmentData> = {
  "Traditional Thai Deep Massage": {
    ...
    pricing: [
      { duration: "45 mins", price: "$85" },
      { duration: "60 mins", price: "$99" },
      { duration: "90 mins", price: "$145" },
      { duration: "120 mins", price: "$195" },
    ],
  },
  "Aromatherapy Oil Massage": {
    title: "Aromatherapy Oil Massage",
    pricing: [
      { duration: "45 mins", price: "$80" },
      { duration: "60 mins", price: "$95" },
      { duration: "90 mins", price: "$139" },
      { duration: "120 mins", price: "$189" },
    ],
  },
  "Swedish Massage": {
  ...
  "Hot Coconut Oil Massage": {
    ...
    pricing: [
      ...
      { duration: "60 mins", price: "$119" },
      { duration: "90 mins", price: "$169" },
      { duration: "120 mins", price: "$229" },
    ],
  },
  "Hot Stone Massage": {
